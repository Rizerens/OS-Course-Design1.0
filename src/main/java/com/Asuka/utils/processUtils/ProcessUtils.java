...
public class ProcessUtils {
    ...
    private static Random random = new Random();                         //用于生成随机数的Random对象

    /**
     * 剩余运行时间范围
     */
    public static final double MIN_REMAINING_TIME = 10;                  // 最小剩余运行时间（秒）
    public static final double MAX_REMAINING_TIME = 109;                 // 最大剩余运行时间（秒）
     ...
     * 获取随机剩余运行时间
     *
     * @return 随机生成的剩余运行时间，范围在MIN_REMAINING_TIME到MAX_REMAINING_TIME之间（秒）
     */
